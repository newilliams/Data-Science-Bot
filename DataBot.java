...
public class DataBot {
	...
	public void readUpVotes(){ 
		 
		int count = 0;
	 File filein = new File("upVotes.txt");
	 int line;
	...
	public void setPostObjects(){
		...
		for( int i = 1; i < posts.length-1; i++) {
			...
			RP[i] = new redditPosts(posts[i] , authors[i], numComments[i], upVotes[i] );
		}
	}
	...
	public void sortedObjectsDescending(){
	...
	public void sortedObjectsAscending(){
